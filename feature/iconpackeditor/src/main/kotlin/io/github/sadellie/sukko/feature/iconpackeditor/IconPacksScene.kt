...
@Composable
internal fun IconPacksScene(onNavigateUp: () -> Unit, navigateToIconPackEditor: (IconPack) -> Unit) {
  ...
  ScaffoldWithLargeTopAppBar(
    ...
    LazyColumn(
      ...
      itemsIndexed(
        ...
        ListItem2(
          content = { Text(iconPack.name) },
          onClick = { onSelect(iconPack) },
          shapes = ListItemDefaults.listedShapes(index, builtIns.size),
        )
      }
      ...
      if (iconPacks.isNotEmpty()) {
        ...
        itemsIndexed(
          ...
          CustomIconPackListItem(
            ...
            iconPack = iconPack,
            shapes = ListItemDefaults.listedShapes(index, iconPacks.size),
          )
        }
      }
    }
...
internal class IconPacksViewModel(private val iconPackCustomRepository: IconPackCustomRepository) :
  ViewModel() {
