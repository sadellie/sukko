...
@Composable
internal actual fun ImportPresetScene(navigateUp: () -> Unit, importingPresetUri: String) {
  val viewModel =
    assistedMetroViewModel<ImportPresetViewModel, ImportPresetViewModel.Factory> {
      create(importingPresetUri)
    }
...
class ImportPresetViewModel(
  @Assisted private val importingPresetUri: String,
  ...
  fun interface Factory : ManualViewModelAssistedFactory {
    fun create(importingPresetUri: String): ImportPresetViewModel
  }
}
