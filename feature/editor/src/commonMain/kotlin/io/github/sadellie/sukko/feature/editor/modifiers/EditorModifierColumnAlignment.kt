...
@Composable
internal fun ReorderableCollectionItemScope.EditorModifierColumnAlignment(
  modifier: Modifier,
  widgetModifier: ColdColumnAlignmentModifier,
  onUpdateModifier: (ColdColumnAlignmentModifier) -> Unit,
