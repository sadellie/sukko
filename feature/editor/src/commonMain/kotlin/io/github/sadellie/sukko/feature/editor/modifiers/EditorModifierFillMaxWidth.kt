...
@Composable
internal fun ReorderableCollectionItemScope.EditorModifierFillMaxWidth(
  modifier: Modifier,
  widgetModifier: ColdFillMaxWidthModifier,
  onUpdateModifier: (ColdFillMaxWidthModifier) -> Unit,
