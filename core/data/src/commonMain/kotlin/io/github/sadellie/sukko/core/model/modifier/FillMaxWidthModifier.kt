...
import io.github.sadellie.sukko.resources.core_model_modifier_fill_max_width
import kotlinx.serialization.Serializable
import kotlinx.serialization.Transient

@Serializable
data class ColdFillMaxWidthModifier(
  override val id: Int,
  val fraction: ScriptableDouble = ScriptableDouble.Fixed(1.0),
) : WidgetModifier.Cold {
  @Transient override val displayName = Res.string.core_model_modifier_fill_max_width
...
data class EvaluatedFillMaxWidthModifier(override val id: Int, val fraction: Float) :
