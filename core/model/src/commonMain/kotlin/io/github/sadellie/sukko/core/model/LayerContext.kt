...
abstract class LayerContext {
  ...
  abstract suspend fun loadAndCacheImage(uri: String): String

  abstract suspend fun loadFontFamily(fontFile: FontFile): FontFamily

  /** Invalidate providers that will may have outdated data on time tick */
...
fun LayerContext.asScriptContext(): BasicScriptContext =
  object : BasicScriptContext {
    ...
    override val mediaCoverUri
      get() = this@asScriptContext.mediaInfoProvider.coverUri
    ...
    override val playerIcon
      get() = this@asScriptContext.mediaInfoProvider.playerIcon
