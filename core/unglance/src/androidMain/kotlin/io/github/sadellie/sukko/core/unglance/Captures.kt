...
fun renderAllWidgetConfigurations(
  ...
  renderWidget(
      ...
      widgetSizes = widgetSizes.toSet(),
      layers = layers,
      imageLoader = imageLoader,
    )
    .map { renderSubResults ->
      ...
      CompositionLocalProvider(
        ...
        for (widgetSize in widgetSizes) {
          ...
          Renderer(
            ...
            layers = layers,
            onGloballyPositioned = { id, layoutCoordinates ->
              allLayerBounds = allLayerBounds + (id to layoutCoordinates.boundsInRoot())
            },
